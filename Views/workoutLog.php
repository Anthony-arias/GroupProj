...
//$sql= "INSERT INTO WORKOUT_LOG(LOG_ID,LOG_DATE,UCWID) VALUES (1, 01/01/0101, '$ucwid')  ";
//mysqli_query($conn,$sql);
/*$sql_query = "SELECT * FROM WORKOUT_LOG AS W WHERE EXISTS
                (SELECT * FROM WORKOUT_LOG WHERE MUSCLES = W.MUSCLE_GROUP)";*/
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-transparent sticky-top">
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="workoutRoutine.php">Workout Routine</a>
                </li>
                <li class="nav-item">
    ...
    <!--This scrip is just an example to show how to retrieve and display cookie data-->
    <script>
        ...
        var user_cwid_cookie = getCookie('user_cwid');
        if (user_cwid_cookie) {
            document.getElementById('displayCWID').textContent = "CWID: " + user_cwid_cookie;
        }
    </script>
